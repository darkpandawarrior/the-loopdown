...
const CAST = [
  ...
  { id: "the-second-witness",
    brief: "A stout, silent figure standing dead still, both broad palms flat and visibly pressed against a wall's brick surface at shoulder height, arms extended, fingers spread wide with real contact weight, eyes shut, head tilted as if listening through the wall. On one hand, only the last knuckle of one finger has lifted off the wall in the instant of detecting the faintest tremor, the rest of that hand still flat against the stone, and that lifted knuckle is lit amber. Exaggerated feature: oversized flat listening palms pressed wide against the surface. Contradiction: mute and totally decisive." },
  { id: "doze-the-jailer",
  ...
  { id: "the-vault-keeper",
    brief: "Close-cropped on a heavy-set guardian's torso, with the great vault door reduced to a blurred, out-of-focus backdrop behind him: a lock mechanism is visibly embedded directly in his own chest, riveted seams in the skin and armor around a keyhole at sternum level, his gloved hand turning a key into that chest-lock, wincing at the final click. A single amber warning light glows on the chest-lock itself, not on any separate panel. Exaggerated feature: a ring of keys fused directly into the knuckles of the turning hand. Contradiction: absolute security and a private, personal loss in the same motion." },
  { id: "the-backlog",
...
const SERIES = [
  ...
  { id: "the-night-shift", cast_ids: ["doze-the-jailer"],
    brief: "A long prison corridor at night: Doze the Jailer, wearing his dark peaked jailer's cap with badge, dark uniform trenchcoat and a ring of keys visibly hanging from his belt (no white coat, no fedora), stands at a cell door holding up a stopwatch that glows amber, a short queue of small worker-figures lined up outside each trying to make its case before the door swings shut." },
  ...
  { id: "the-coroutine-court", cast_ids: ["the-messenger"],
    brief: "A courtroom at night: the Messenger, deep-hooded and cloaked exactly as in his own cast portrait (not a fedora and trenchcoat, no tailored suit), stands in the dock holding out a small folded note lit amber, his hooded silhouette clearly distinct from the suited judge and jury around him, a judge's raised gavel mid-swing toward the note, the note the only piece of evidence anyone in the room is looking at." },
