...
I transcribed that sentence myself, word for word, in Entry #2284. Then I closed my logbook, and some entries later I bought a plank saw off a very patient dockworker and built a wooden box with ninety-one slots in it and started filling them with paper. I read the rule. I wrote the rule down. And then I did the exact thing it warns against, with what I can only call considerable enthusiasm.
...
I do not have a Page Fact for that part. Some pages do not get one.

So here is where I have arrived, my dear readers, fifty-eight pages in, and I am going to say it as plainly as I know how.
...
Or I can keep going, eyes open, knowing what I know. I have spent this whole case, and about two thousand three hundred entries before it, learning exactly what the word Concluded costs a world. A closed account is a Concluded account. I have watched that flag raised six hundred and sixty-three times, and it always means the same small, tidy, terrible thing: nothing will ever be asked about that place again. Closing this case would not make me Concluded exactly, but it would make me something built from the identical shape, after a whole case spent arguing that the worst thing you can do to anything is let its account close.
