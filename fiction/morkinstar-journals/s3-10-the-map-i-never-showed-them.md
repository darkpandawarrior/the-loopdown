...
# The Map I Never Showed Them

> Kindling · page 38 withdrawn

Greetings again, my dear readers. Page thirty eight.

Some of you will remember this one without my help. Six worlds, each with something buried or carved or planted, aimed at a bearing and not a direction, on the theory that a monster driven off does not stop existing, it goes somewhere. Ossul pinned all six to his board and ran thread from each, and three pairs of lines came down on top of each other almost exactly, on a scale of light years, using instruments none of the six worlds know the others own.

Say it the plain way, because the page said it the plain way and I am not going to dress it up now that it is the last time anyone will read it. The Hraedh have been aiming four billion standing graves at Vædrun for four thousand clicks. Vædrun has been aiming a line of counting poles back at the Hraedh for nearly as long. Neither of them knows. Both of them think they are watching empty sky. I am the only entity in the recorded history of the galaxy who has seen both lines on the same table at the same time, and the other two pairs besides, and I have known that for a season and told nobody, on either world, or anywhere else.

That is not new information tonight. What is new is what happens to it in about four minutes.

Nobody else has this. I asked Ossul, that day, not to file the six coordinates as a matched pair, and he did not ask me why, and he did not write anything down, which is the one instruction in his entire career I am fairly sure he actually honoured to the letter. Deep Registry has six positions on file the way it has every position on file. It does not have the thread. The thread was on a second board with nothing on it but distance, and the second board came down that same night. So the map, the actual map, the one where the six lines mean something because somebody laid them next to each other on purpose, exists in exactly one place, which is this page, which is in my hand, over a fire I lit for reasons that have nothing to do with cartography.

When this goes in, the map stops existing. Not becomes harder to find. Stops existing. Nobody has plotted it since, because I asked the one person who could to specifically not.
